...
function draw() {
    ...
    currentImage = spriteLibrary[indexNum % spriteLibrary.length];
    currentImage.show();
    currentImage.position(windowWidth/2, imagesScootY);
    if (currentImage !== prevImage && prevImage) {
        prevImage.hide();
    }
    prevImage = currentImage;
    // image(currentImage, 0, 200);
    // }
}
...
var obj = {};
obj[val1] = [val3, val2]; //can I still add probability to this?
obj[val2] = [val1, val3];
obj[val3] = [val2, val4];
obj[val4] = [val5, val3];
obj[val5] = [val4, val6];
